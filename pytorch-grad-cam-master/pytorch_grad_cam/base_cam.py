...
class BaseCAM:
    ...
    def get_cam_image(
        ...
        if len(activations.shape) == 4:
            if weights.shape[1] != activations.shape[1]:
                raise ValueError("Mismatch between weight and activation dimensions.")
    ...
    def forward(
        ...
        #print("forward func: input_tensor = {} \n targets = {} \n".format(input_tensor, targets))
    ...
    def compute_cam_per_layer(
        ...
        #print("compute_cam_per_layer func: activations_list = {} \n grads_list = {} \n".format(activations_list, grads_list))
        #print("compute_cam_per_layer func: activations_and_grads: activations_list = {} \n grads_list = {}".format(activations_list, grads_list))

        # Loop over the saliency image from every layer
        #print(f'Activations_list\'s length = {len(activations_list)}')
        #print(f'Grads_list\'s length = {len(grads_list)}')
